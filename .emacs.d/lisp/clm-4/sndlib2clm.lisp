...
#+(or allegro-v7.0 allegro-v8.0 allegro-v8.1 allegro-v8.2) (ff:def-foreign-call (mus-sound-frames "clm_sound_frames") ((arg (* :char))) :strings-convert t :returning :int)
#+openmcl (defun mus-sound-frames (file) (ccl:with-cstrs ((f file)) (ccl::external-call (clm_ffi_name "mus_sound_frames") :address f (:signed 64))))
...
#+(or allegro-v7.0 allegro-v8.0 allegro-v8.1 allegro-v8.2) (ff:def-foreign-call (mus-sound-data-format "mus_sound_data_format") ((arg (* :char))) :strings-convert t :returning :int)
#+openmcl (defun mus-sound-data-format (file) (ccl:with-cstrs ((f file)) (ccl::external-call (clm_ffi_name "mus_sound_data_format") :address f :signed)))
...
#+(or allegro-v7.0 allegro-v8.0 allegro-v8.1 allegro-v8.2) (ff:def-foreign-call (mus-sound-original-format "mus_sound_original_format") ((arg (* :char))) :strings-convert t :returning :int)
#+openmcl (defun mus-sound-original-format (file) (ccl:with-cstrs ((f file)) (ccl::external-call (clm_ffi_name "mus_sound_original_format") :address f :signed)))
...
#+(or allegro-v7.0 allegro-v8.0 allegro-v8.1 allegro-v8.2) (ff:def-foreign-call (mus-data-format-name "mus_data_format_name") ((format :int)) :strings-convert t :returning ((* :char)))
#+openmcl (defun mus-data-format-name (typ) (get-cstring (ccl::external-call (clm_ffi_name "mus_data_format_name") :signed typ :address)))
...
#+(or allegro-v7.0 allegro-v8.0 allegro-v8.1 allegro-v8.2) (ff:def-foreign-call (mus-prescaler "mus_prescaler") (:void) :returning :double)
#+openmcl (defun mus-prescaler () (ccl::external-call (clm_ffi_name "mus_prescaler") :double-float))
...
#+(or allegro-v7.0 allegro-v8.0 allegro-v8.1 allegro-v8.2) (ff:def-foreign-call (mus-set-prescaler "mus_set_prescaler") ((val :double)) :strings-convert t :returning :double)
#+openmcl (defun mus-set-prescaler (val) (ccl::external-call (clm_ffi_name "mus_set_prescaler") :double-float val :single-float))
...
#+(or allegro-v7.0 allegro-v8.0 allegro-v8.1 allegro-v8.2) (ff:def-foreign-call (mus-header-format "mus_header_format") (:void) :strings-convert t :returning :int)
#+openmcl (defun mus-header-format () (ccl::external-call (clm_ffi_name "mus_header_format") :signed))
...
#+(or allegro-v7.0 allegro-v8.0 allegro-v8.1 allegro-v8.2) (ff:def-foreign-call (mus-header-original-format "mus_header_original_format") (:void) :strings-convert t :returning :int)
#+openmcl (defun mus-header-original-format () (ccl::external-call (clm_ffi_name "mus_header_original_format") :signed))
...
#+(or allegro-v7.0 allegro-v8.0 allegro-v8.1 allegro-v8.2) (ff:def-foreign-call (mus-header-original-format-name "mus_header_original_format_name")
				    ((format :int) (type :int)) :strings-convert t :returning ((* :char)))
#+openmcl (defun mus-header-original-format-name (format type)
	    (get-cstring (ccl::external-call (clm_ffi_name "mus_header_original_format_name") :signed format :signed type :address)))
