...
(export '(
	  ...
	  fft multiply-arrays make-fft-window rectangular->polar spectrum convolution polar->rectangular rectangular->magnitudes
	  ...
	  sound-length sound-samples sound-frames sound-srate sound-header-type sound-loop-info
