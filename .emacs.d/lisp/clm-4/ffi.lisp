...
(defun sound-frames (name) (mus-sound-frames (fullname name "sound-frames")))
...
(progn
  ...
  (defun clm-random (amp) (ccl::external-call (clm_ffi_name "mus_frandom") :double-float amp :double-float))
